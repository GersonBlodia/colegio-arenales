...
export const HeaderComponent: React.FC<HeaderProps> = ({ onMobileMenuToggle, isMobileMenuOpen }) => {
  ...
  const [notifications] = useState([
    { id: 1, title: 'Nueva tarea asignada', message: 'Matemáticas - Ejercicios cap. 5', time: '5 min', unread: true },
    { id: 2, title: 'Calificación disponible', message: 'Historia - Examen parcial', time: '1 h', unread: true },
    { id: 3, title: 'Recordatorio', message: 'Reunión de padres mañana', time: '2 h', unread: false }
  ]);
      ...
      <div className="flex items-center justify-between h-16 px-4 lg:px-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden sm:block">
            ...
            >
              Bienvenido de vuelta, {usuario?.name}
            </motion.p>
          </div>
        </div>
            ...
            <AnimatePresence>
              {isProfileOpen && (
                ...
                >
                  ...
                  {[
                    { icon: UserCircleIcon, label: 'Mi Perfil', href: '/profile' },
                    { icon: Cog6ToothIcon, label: 'Configuración', href: '/settings' },
                  ].map((item, index) => (
                    <motion.a
                      key={item.label}
                      href={item.href}
